...
<head>
  ...
  <title><?=$info['nama_yayasan'];?> - Tambah Data Anak</title>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-info">Tambah Data Anak</h6>
                </div>
                <div class="card-body">
              <form class="user" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                	...
                	<textarea name="alamat" class="form-control form-control-user"> </textarea>
                </div>
                <div class="form-group">
				...
				<?php if($_POST['nama']){
                  ...
                  if(isset($_FILES["gambar"])){
                    ...
                    if ($_FILES["gambar"]["error"] > 0){
                      ...
                      $subm = "INSERT INTO anak_bina (gambar_anak,nama_anak,ttl_anak,tempat_anak,alamat_anak,pendidikan_anak,status_anak,mukim_anak,id_petugas) VALUES ('$file_name','$nama','$tgl','$tempat','$alamat','$pendidikan','$status','$mukim','$idpetugas')";
                      $submit = $conn->query($subm);
                      echo '<script>window.alert("Sukses..");window.location = "anak.php";</script>';
                    }
                  }else{
